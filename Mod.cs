...
namespace KitchenSpamton
{
    public class Mod : BaseMod, IModSystem
    {
        ...
        public const string MOD_GUID = "com.martoph.spamtonskinpack";
        public const string MOD_NAME = "Spamton Us Skin Pack";
        ...
        public Mod() : base(MOD_GUID, MOD_NAME, MOD_AUTHOR, MOD_VERSION, MOD_GAMEVERSION,
        ...
        private void AddGameData()
        {
            ...
            AddGameDataObject<SpamtonPlayerModel>();
